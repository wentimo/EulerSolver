...
namespace EulersSolver.Problems
{
    ...
    {
        protected override int ProblemNumber => 23;
        ...
        protected override void Solve()
        {
            ...
            */
            ...
            DebugLogElapsedTime("Before Abundant Numbers:");
            var abundantNumbers = GetAbundantNumbers();
            DebugLogElapsedTime("GetAbundantNumbers");
            ...
            DebugLogElapsedTime("GetCombinations");
        ...
        static HashSet<int> GetCombinations(List<int> abundantNumbers)
        {
        ...
        static List<int> GetAbundantNumbers()
        {
        ...
        static List<int> GetAbundantNumbersNew()
        {
            int lowBound = 12, highBound = 28124;
            var range = Enumerable.Range(lowBound, highBound);
